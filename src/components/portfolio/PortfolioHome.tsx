...
function RoleRotator() {
    ...
    return (
        <span className="text-[#00d4ff] font-semibold inline-block min-w-[220px] text-left">
...
export function PortfolioHome() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-[#0A0A0B]">
            {/* Dynamic Cursor Glow */}
            <motion.div
                className="pointer-events-none fixed top-0 left-0 w-[500px] h-[500px] rounded-full sm:block hidden z-0"
                style={{
                    x: smoothX,
                    y: smoothY,
                    translateX: "-50%",
            ...
            <div className="relative z-10">
              ...
              // Portfolio Initialized
                        ...
                        {/* Tagline / Roles */}
                        <motion.div
                            className="font-mono text-[#94a3b8] text-base sm:text-lg tracking-wide mb-8 flex items-center justify-center gap-2 flex-wrap"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
